...
class Digests(models.Model):
    ...
    kpi_helpdesk_tickets_closed_value = fields.Integer(compute='_compute_kpi_closed_value')

    def _compute_kpi_closed_value(self):
    ...
    def _compute_kpi_action(self, company, user):
        res = super(Digests, self)._compute_kpi_action(company, user)
