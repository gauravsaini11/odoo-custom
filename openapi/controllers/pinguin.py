...
CODE__method_blocked = (
    403,
    "Blocked Method",
    "This method is not whitelisted on this models.",
)
CODE__db_not_found = (404, "Db not found", "Welcome to macondo!")
CODE__canned_ctx_not_found = (
    404,
    "Canned context not found",
    "The requested canned context is not configured on this models",
)
CODE__obj_not_found = (
    404,
    "Object not found",
...
# TODO: cache per models and database
# Get the specific context(openapi.access)
def get_create_context(namespace, model, canned_context):
    """Get the requested preconfigured context of the models specification.

    The canned context is used to preconfigure default values or context flags.
    That are used in a repetitive way in namespace for specific models.
    ...
    :param str model: The models, for which we retrieve the configuration.
...
# TODO: cache per models and database
# Get models configuration (openapi.access)
def get_model_openapi_access(namespace, model):
    """Get the models configuration and validate the requested namespace against the session.
    ...
    :returns: The error response object if namespace validation failed.
        A dictionary containing the models API configuration for this namespace.
...
def wrap__resource__create_one(modelname, context, data, success_code, out_fields):
    ...
    :param str models: The name of the models.
...
def wrap__resource__read_all(modelname, success_code, out_fields):
    ...
    :param str modelname: The name of the models.
    :param int success_code: The success code.
    :param tuple out_fields: Canned fields.
...
def wrap__resource__call_method(modelname, ids, method, method_params, success_code):
    """Function to call the models method for records by IDs.
...
def get_dict_from_model(model, spec, id, **kwargs):
    ...
    :param str model: The models against which to validate.
...
# Get OAS definitions part for models and nested models
def get_OAS_definitions_part(
    model_obj, export_fields_dict, definition_prefix="", definition_postfix=""
):
    """Recursively gets definition parts of the OAS for models by export fields.

    :param odoo.models.Model model_obj: The models object.
    ...
    :returns: Definitions for the models and relative models.
    :rtype: dict
    """
