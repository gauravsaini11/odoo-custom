...
# We also check if the models is installed in the database.
...
class ApiV1Controller(http.Controller):
    ...
    .. methods:
        ...
        CRUD Methods:
        - `POST     .../<models>`               -> `CreateOne`
        - `PUT      .../<models>/<id>`          -> `UpdateOne`
        - `GET      .../<models>`               -> `ReadMulti`
        - `GET      .../<models>/<id>`          -> `ReadOne`
        - `DELETE   .../<models>/<id>`          -> `UnlinkOne`

        Auxiliary Methods:
        - `PATCH    .../<models>/<id>/<method>`               -> `Call Method on Singleton Record`
        - `PATCH    .../<models>/<method>`                    -> `Call Method on RecordSet`
    ...
    # CreateOne # ReadMulti
    _api_endpoint_model = _api_endpoint + "/<models>"
    # ReadOne # UpdateOne # UnlinkOne
    _api_endpoint_model_id = _api_endpoint + "/<models>/<int:id>"
    # Call Method on Singleton Record
    _api_endpoint_model_id_method = (
        _api_endpoint + "/<models>/<int:id>/call/<method_name>"
    )
    # Call Method on RecordSet
    _api_endpoint_model_method = _api_endpoint + "/<models>/call/<method_name>"
    _api_endpoint_model_method_ids = _api_endpoint + "/<models>/call/<method_name>/<ids>"
    # Get Reports
    _api_report_docids = (
        _api_endpoint
    ...
    def create_one__POST(self, namespace, model, **data):
        ...
        #     context = get_create_context(namespace, models, kw.get('context'))
        # else:
