...
class FieldConfiguration(models.Model):
    ...
    model_id = fields.Many2one('ir.models', string='Model', required=True, ondelete="cascade")
    field_id = fields.Many2one('ir.models.fields', string='Field', required=True, ondelete="cascade")
