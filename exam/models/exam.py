...
class ExamScheduleLine(models.Model):
    """Defining models for exam schedule line details."""
...
class AdditionalExam(models.Model):
    """Defining models for additional exam."""
...
class ExamResult(models.Model):
    ...
    message_ids = fields.One2many(
        ...
        "res_id",
        "Messages",
        domain=lambda self: [("models", "=", self._name)],
        auto_join=True,
...
class ExamGradeLine(models.Model):
    """Defining models for Exam Grade Line."""
...
class ExamSubject(models.Model):
    """Defining models for Exam Subject Information."""
...
class AdditionalExamResult(models.Model):
    """Defining models for Additional Exam Result."""
