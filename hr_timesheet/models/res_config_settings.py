...
class ResConfigSettings(models.TransientModel):
    ...
    module_project_timesheet_synchro = fields.Boolean("Awesome Timesheet",
        compute="_compute_timesheets_modules", store=True, readonly=False)
    ...
    is_encode_uom_days = fields.Boolean(compute='_compute_is_encode_uom_day')

    @api.depends('timesheet_encode_uom_id')
    def _compute_is_encode_uom_day(self):
    ...
    def _compute_timesheets_modules(self):
